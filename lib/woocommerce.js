...
export async function getBookRedeemers(bookProductId) {
  ...
  // _fields limita a resposta só ao essencial -> muito mais rápido (evita timeout).
  const base = { product: bookProductId, per_page: 100, status: 'any', _fields: 'id,status,billing,coupon_lines' };
